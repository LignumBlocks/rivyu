...
- Location: Must be applicable under U.S. financial regulations and commonly available U.S. financial programs. Do not include location-specific programs that are limited to other countries.
...
Initial hack title:\n[{hack_title}]\n---\nBrief summary:\n[{hack_summary}]\n---\n
Your task is to provide a comprehensive analysis of the financial hack described above, adhering to the following guidelines. The result will be read directly by a user, keep that in mind. The analysis should be deeply detailed, structured, and articulate, providing the user with a clear understanding of this financial hack and its implications. Only answer about the indications in the guideline. The style should be in 2nd person, speaking to a user. Never mention 'this hack', substitute that for a reference to the title. Adapt examples and terminology to the USA. Align with current laws and regulations in the USA and specific states. Do not include location-specific programs that are limited to other countries.
